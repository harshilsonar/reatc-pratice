      ...
      <div className="max-w-9xl mx-auto px-6">
        <div className="flex items-center justify-between h-24">
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <button className="w-11 h-11 rounded-full bg-gray-100 flex items-center justify-center hover:bg-yellow-700 hover:text-white transition-all duration-300 hover:scale-110 hover:rotate-12 shadow">
        ...
        <Link to="cart"><button
            ...
            <Link to="/signin">
              <button className="ml-2 px-6 py-2.5 rounded-full bg-gradient-to-r from-yellow-500 to-yellow-700 text-white font-semibold shadow-lg hover:shadow-yellow-400/40 hover:scale-105 transition-all duration-300">
                Sign In
              </button>
            </Link>
